...
*/
                      ...
                      movieImage.innerHTML = `<img src=${poster} alt='empty.png'/>`
                      
                      // add title and year
                      movieDescription.innerHTML = `<h3>${title}<br>Released in:: ${year} </h3>`
                      
                      nomBtn.innerText = "Save"
                    }
                    else{
                    ...
                    function nominate(){
                      ...
                      if(nodeListArray === 10){
                        alert("You have nominated 10 of your favorite movies")
                      }
                    }
